...
('Marché de Maussane-les-Alpilles', 'Maussane-les-Alpilles', 'Bouches-du-Rhône', 43.7167, 4.8000, 'Monday', ARRAY['food'], 'seasonal', ARRAY[4,5,6,7,8,9,10], '13520', 'https://www.maussane.com', 'Small village market at the heart of the Alpilles olive country. Local oil, tapenades, and seasonal produce.'),
...
('Marché de Châteaurenard', 'Châteaurenard', 'Bouches-du-Rhône', 43.8820, 4.8506, 'Monday', ARRAY['food'], 'year_round', NULL, '13160', 'https://www.chateaurenard.fr', 'One of the most important wholesale fruit and vegetable markets in France, with a lively retail market alongside.'),
...
('Marché de Fontvieille', 'Fontvieille', 'Bouches-du-Rhône', 43.7269, 4.7116, 'Thursday', ARRAY['food'], 'seasonal', ARRAY[4,5,6,7,8,9], '13990', 'https://www.fontvieille.fr', 'Charming small market near Alphonse Daudet''s windmill. Summer season only. Local olives, honey, and lavender products.'),
...
('Marché d''Eygalières', 'Eygalières', 'Bouches-du-Rhône', 43.7667, 4.9440, 'Monday', ARRAY['food','crafts'], 'seasonal', ARRAY[5,6,7,8,9,10], '13810', 'https://www.eygalieres.fr', 'Tiny and beautiful market in one of the Alpilles'' most charming villages. Local producers only. Summer season.');
...
('Marché de Sisteron', 'Sisteron', 'Alpes-de-Haute-Provence', 44.2006, 5.9419, 'Wednesday', ARRAY['food'], 'year_round', NULL, '04200', 'https://www.sisteron.fr', 'Market under the famous citadel. Sisteron lamb (Agneau de Sisteron AOC) is world-class. Wednesday and Saturday. Worth a stop on any journey north-south through Provence.'),
