...
<img src="/images/Lavender/lav-sault.jpg" alt="The high-altitude lavender fields near Sault" style="width:100%;border-radius:2px;margin:1.5rem 0;" />
...
<img src="/images/Lavender/lav-sault.jpg" alt="Les champs de lavande en altitude près de Sault" style="width:100%;border-radius:2px;margin:1.5rem 0;" />
...
<p>Si vous avez une version fiable, je serais vraiment ravi de l'entendre. Laissez-la dans les commentaires ci-dessous.</p>`,
  ...
  {
    slug: 'a-day-chasing-lavender',
    title: 'A Day Chasing Lavender in Provence',
...
<p>At 7:13 we spotted our first lavender fields. A quick stop for a few photos soon turned into another when we found a field where rows of lavender stood beside a field of sunflowers, two colours arguing politely over the same stretch of dirt. Unfortunately, a group had decided to turn the middle of the field into their own private photography studio. After waiting patiently for about fifteen minutes, hoping they'd finish, we eventually moved on.</p>
<img src="/images/Lavender/ChasingLavender/chase-sunflower-field.jpg" alt="Lavender rows beside a sunflower field near Valensole" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
<h2>Spiderwebs, Bees and a Reluctant Daughter</h2>
<p>One thing I'd never noticed before is that almost every lavender row begins with dozens of spiderwebs. It makes sense once you think about it. The insects drawn in by the scent get blown into the webs by the wind. It also explains why little girls become rather reluctant to walk down the rows when Dad wants "just one more photo."</p>
<img src="/images/Lavender/ChasingLavender/chase-girl-walking.jpg" alt="Our daughter walking down a lavender row in Valensole" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
<p>Lavender fields in full bloom are essentially functioning beehives at ground level, and the bees were not shy about reminding us of that.</p>
<img src="/images/Lavender/ChasingLavender/chase-bee-macro.jpg" alt="A bee working a lavender bloom in Valensole" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
...
<img src="/images/Lavender/ChasingLavender/chase-rows-ventoux.jpg" alt="Lavender rows stretching towards Mont Ventoux" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
<h2>Wheat and Lavender, Side by Side</h2>
<p>Just off the beaten track we came across a wheat field growing right alongside a lavender field, gold and purple sharing a single fence line. It's the kind of contrast that photographs better than I expected, and we lingered there a while longer than planned.</p>
<img src="/images/Lavender/ChasingLavender/chase-wheat-contrast.jpg" alt="A wheat field growing beside a lavender field near Valensole" style="width:100%;border-radius:2px;margin:1.5rem 0;" />
<p>After a busy morning we returned to the Petit U in Valensole for a litre of milk and some instant coffee. It might sound odd, but instant coffee mixed with cold milk makes a surprisingly good iced coffee, and it's become one of our favourite road trip treats.</p>
<h2>A Detour to Lac de Sainte-Croix</h2>
<p>Our original plan had been to spend the rest of the day around Valensole, but my wife had discovered the day before that Lac de Sainte-Croix wasn't far away. I already knew that and had deliberately not mentioned it, because I knew it would mean a detour. I'm very glad she did.</p>
<p>On the way we drove through Riez, where the Sunday market was in full swing, then found ourselves stuck behind a farmer moving his flock of sheep through the streets to another field. Nobody seemed particularly bothered, and after about twenty minutes we were on our way again.</p>
<p>When we reached the lake we stopped at one of the viewpoints before making our way down to the bridge. The water was unbelievably turquoise, and watching people paddle out toward the entrance of the Gorges du Verdon made us wish we'd brought our swimming gear. Our youngest daughter certainly wished we had. Determined to swim, she convinced us to look for children's swimwear, but I couldn't bring myself to pay the asking price for a child's bikini. We headed back to Moustiers-Sainte-Marie instead.</p>
<img src="/images/Lavender/ChasingLavender/chase-verdon-aerial.jpg" alt="Turquoise water at the entrance to the Gorges du Verdon" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
<h2>Moustiers-Sainte-Marie, Almost Missed</h2>
<p>Finding parking proved to be another adventure. We drove all the way to the top of the village before deciding the walk back down, and more importantly back up, wasn't appealing in the afternoon heat. I dropped my wife and daughter near the centre while they searched for swimwear, and as if by magic, a parking space opened up directly in front of me. Sometimes Provence smiles on you.</p>
<img src="/images/Lavender/ChasingLavender/chase-moustiers-square.jpg" alt="The village square of Moustiers-Sainte-Marie below the cliffs" style="width:100%;border-radius:2px;margin:1.5rem 0;" />
<p>While they were shopping, I wandered into the village with my camera and realised what we'd nearly missed. Moustiers-Sainte-Marie is stunning. Narrow streets, old stone buildings, hidden corners, flowers everywhere. It's one of those villages where every corner offers another photograph.</p>
<img src="/images/Lavender/ChasingLavender/chase-moustiers-alley.jpg" alt="A flower-lined alley in Moustiers-Sainte-Marie" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
<h2>The Sorbet Incident</h2>
<p>By the time I met up with my wife and daughter, swimming could wait for another day. We kept exploring instead, until my daughter asked for an ice cream. Mine was salted caramel topped with a lemon and thyme sorbet, which in hindsight wasn't my brightest decision. Sorbet melts much faster than ice cream, and while I struggled to keep mine under control, my nine year old never stood a chance. While desperately trying to save the rapidly melting top scoop, it detached itself from the cone and landed squarely on my wife's shorts, leg and foot.</p>
<p>From that moment, everything became sticky. Back at the car I helped clean her leg and foot with what felt like half a packet of wet wipes. Her shoes, however, remained permanently sticky, and in the French countryside, sticky things attract flies. Lots of flies. Fortunately we'd bought a fly swatter the previous day and it happened to be in the car. Every time we eliminated one persistent passenger, another would wander in through an open door or window somewhere down the road.</p>
<h2>Behind the Lavender Tractor</h2>
<p>Just before reaching Valensole again we found ourselves behind a tractor pulling a trailer loaded with freshly harvested lavender. Even with the windows closed, the fragrance found its way in through the air conditioning. I rolled the windows down without giving the flies a second thought. For several kilometres we simply followed the tractor at its leisurely pace, surrounded by the scent of freshly cut lavender. Sometimes the best moments happen when you're forced to slow down.</p>
<img src="/images/Lavender/ChasingLavender/chase-row-panorama.jpg" alt="A row of freshly bloomed lavender bushes near Valensole" style="width:100%;border-radius:2px;margin:1.5rem 0;" />
...
<img src="/images/Lavender/ChasingLavender/chase-bloom-macro.jpg" alt="A close up of a lavender bloom under the afternoon sun" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
<p>With the temperature climbing steadily, we ate our picnic in the air conditioned comfort of the car on the way home. By 4:30 that afternoon we were back, tired, slightly sunburnt, smelling faintly of lavender, with memory cards full of photos and enough stories to keep us smiling for quite some time. All in all, I'd call that a very good day's work.</p>`,
    ...
    date: '2026-06-30',
    category: 'Provence',
    marcelTip: 'Buy the children\'s swimwear before you need it, not after. And never trust a lemon and thyme sorbet on a hot afternoon.',
    marcelType: 'gardener',
    fr: {
      title: 'Une Journée à la Poursuite de la Lavande en Provence',
...
<p>À 7h13, nous avons aperçu nos premiers champs de lavande. Un court arrêt photo s'est vite transformé en un autre lorsque nous avons trouvé un champ où des rangées de lavande côtoyaient un champ de tournesols, deux couleurs se disputant poliment le même bout de terre. Malheureusement, un groupe avait transformé le milieu du champ en studio photo privé. Après avoir patienté environ un quart d'heure en espérant qu'ils finissent, nous avons fini par poursuivre notre route.</p>
<img src="/images/Lavender/ChasingLavender/chase-sunflower-field.jpg" alt="Rangées de lavande à côté d'un champ de tournesols près de Valensole" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
<h2>Toiles d'Araignées, Abeilles et une Fille Réticente</h2>
<p>Une chose que je n'avais jamais remarquée auparavant, c'est que presque chaque rangée de lavande commence par des dizaines de toiles d'araignées. Cela se comprend quand on y pense. Les insectes attirés par le parfum sont poussés dans les toiles par le vent. Cela explique aussi pourquoi les petites filles deviennent plutôt réticentes à marcher dans les rangées quand Papa veut "juste une photo de plus."</p>
<img src="/images/Lavender/ChasingLavender/chase-girl-walking.jpg" alt="Notre fille marchant dans une rangée de lavande à Valensole" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
<p>Les champs de lavande en pleine floraison sont essentiellement des ruches fonctionnelles au niveau du sol, et les abeilles n'ont pas hésité à nous le rappeler.</p>
<img src="/images/Lavender/ChasingLavender/chase-bee-macro.jpg" alt="Une abeille butinant une fleur de lavande à Valensole" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
<p>Un champ particulièrement beau avait des rangées sans fin disparaissant à l'horizon, le Mont Ventoux dans une brume lointaine. Hélas, il était lui aussi occupé, cette fois par une famille apparemment déterminée à utiliser jusqu'au dernier gigaoctet de leur stockage en ligne. Une fois qu'ils eurent terminé, nous avons pris quelques photos et continué. J'ai aussi essayé de filmer les champs avec mon drone, mais j'ai eu du mal à le connecter à mon téléphone. J'ai fini par le piloter uniquement à la manette, et je n'ai toujours pas eu le courage de regarder les images.</p>
<img src="/images/Lavender/ChasingLavender/chase-rows-ventoux.jpg" alt="Rangées de lavande s'étendant vers le Mont Ventoux" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
<h2>Blé et Lavande, Côte à Côte</h2>
<p>Un peu à l'écart des sentiers battus, nous sommes tombés sur un champ de blé poussant juste à côté d'un champ de lavande, l'or et le violet partageant la même clôture. C'est le genre de contraste qui se photographie mieux que je ne l'aurais cru, et nous nous y sommes attardés plus longtemps que prévu.</p>
<img src="/images/Lavender/ChasingLavender/chase-wheat-contrast.jpg" alt="Un champ de blé poussant à côté d'un champ de lavande près de Valensole" style="width:100%;border-radius:2px;margin:1.5rem 0;" />
<p>Après une matinée bien remplie, nous sommes retournés au Petit U de Valensole pour un litre de lait et du café instantané. Cela peut paraître étrange, mais du café instantané mélangé à du lait froid fait un excellent café glacé improvisé, et c'est devenu l'une de nos friandises de road trip préférées.</p>
<h2>Un Détour par le Lac de Sainte-Croix</h2>
<p>Notre plan initial était de passer le reste de la journée autour de Valensole, mais ma femme avait découvert la veille que le Lac de Sainte-Croix n'était pas très loin. Je le savais déjà et j'avais délibérément évité d'en parler, sachant que cela voudrait dire un détour. Je suis très heureux qu'elle l'ait fait.</p>
<p>En chemin, nous avons traversé Riez, où le marché du dimanche battait son plein, puis nous nous sommes retrouvés coincés derrière un berger déplaçant son troupeau de moutons dans les rues vers un autre champ. Personne ne semblait particulièrement dérangé, et après une vingtaine de minutes, nous avons repris la route.</p>
<p>En arrivant au lac, nous nous sommes arrêtés à l'un des points de vue avant de descendre vers le pont. L'eau était d'un turquoise incroyable, et voir les gens pagayer vers l'entrée des Gorges du Verdon nous a donné envie d'avoir apporté nos maillots de bain. Notre fille cadette en avait certainement envie. Déterminée à se baigner, elle nous a convaincus de chercher un maillot pour enfant, mais je n'ai pas pu me résoudre à payer le prix demandé pour un bikini d'enfant. Nous sommes retournés à Moustiers-Sainte-Marie à la place.</p>
<img src="/images/Lavender/ChasingLavender/chase-verdon-aerial.jpg" alt="Eau turquoise à l'entrée des Gorges du Verdon" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
<h2>Moustiers-Sainte-Marie, Presque Manqué</h2>
<p>Trouver une place de parking s'est révélé être une autre aventure. Nous sommes montés jusqu'en haut du village avant de décider que la descente, et surtout la remontée, ne nous tentait pas dans la chaleur de l'après-midi. J'ai déposé ma femme et ma fille près du centre pendant qu'elles cherchaient des maillots, et comme par magie, une place s'est libérée juste devant moi. Parfois, la Provence vous sourit.</p>
<img src="/images/Lavender/ChasingLavender/chase-moustiers-square.jpg" alt="La place du village de Moustiers-Sainte-Marie sous les falaises" style="width:100%;border-radius:2px;margin:1.5rem 0;" />
<p>Pendant qu'elles faisaient du shopping, je me suis promené dans le village avec mon appareil photo et j'ai réalisé ce que nous avions failli manquer. Moustiers-Sainte-Marie est magnifique. Ruelles étroites, vieilles bâtisses en pierre, recoins cachés, des fleurs partout. C'est l'un de ces villages où chaque coin de rue offre une nouvelle photo.</p>
<img src="/images/Lavender/ChasingLavender/chase-moustiers-alley.jpg" alt="Une ruelle fleurie à Moustiers-Sainte-Marie" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
<h2>L'Incident du Sorbet</h2>
<p>Quand j'ai retrouvé ma femme et ma fille, la baignade pouvait attendre un autre jour. Nous avons continué à explorer, jusqu'à ce que ma fille demande une glace. La mienne était caramel au beurre salé surmontée d'un sorbet citron-thym, ce qui avec le recul n'était pas ma décision la plus brillante. Le sorbet fond bien plus vite que la glace, et pendant que je luttais pour garder la mienne sous contrôle, ma fille de neuf ans n'avait aucune chance. En essayant désespérément de sauver la boule du dessus qui fondait rapidement, celle-ci s'est détachée du cône et a atterri en plein sur le short, la jambe et le pied de ma femme.</p>
<p>À partir de ce moment, tout est devenu collant. De retour à la voiture, j'ai aidé à nettoyer sa jambe et son pied avec ce qui ressemblait à la moitié d'un paquet de lingettes. Ses chaussures, en revanche, sont restées définitivement collantes, et dans la campagne française, les choses collantes attirent les mouches. Beaucoup de mouches. Heureusement, nous avions acheté une tapette à mouches la veille et elle se trouvait dans la voiture. Chaque fois que nous éliminions un passager particulièrement tenace, un autre s'invitait par une porte ou une fenêtre ouverte un peu plus loin sur la route.</p>
<h2>Derrière le Tracteur de Lavande</h2>
<p>Juste avant de revenir à Valensole, nous nous sommes retrouvés derrière un tracteur tirant une remorque chargée de lavande fraîchement coupée. Même vitres fermées, le parfum trouvait son chemin par la climatisation. J'ai baissé les vitres sans plus penser aux mouches. Pendant plusieurs kilomètres, nous avons simplement suivi le tracteur à son rythme tranquille, enveloppés par le parfum de la lavande fraîchement coupée. Parfois, les meilleurs moments arrivent quand on est forcé de ralentir.</p>
<img src="/images/Lavender/ChasingLavender/chase-row-panorama.jpg" alt="Une rangée de lavande fraîchement fleurie près de Valensole" style="width:100%;border-radius:2px;margin:1.5rem 0;" />
...
<img src="/images/Lavender/ChasingLavender/chase-bloom-macro.jpg" alt="Gros plan sur une fleur de lavande sous le soleil de l'après-midi" style="width:100%;height:310px;object-fit:cover;border-radius:2px;margin:1.5rem 0;" />
<p>Avec la température qui montait régulièrement, nous avons mangé notre pique-nique dans le confort climatisé de la voiture sur le chemin du retour. À 16h30, nous étions de retour, fatigués, légèrement brûlés par le soleil, sentant vaguement la lavande, avec des cartes mémoire pleines de photos et assez d'histoires pour nous faire sourire pendant un bon moment. Tout compte fait, je dirais que c'était une très bonne journée de travail.</p>`,
  ...
  },
  {
    ...
    excerpt: 'A Federal 2 away fixture on the Mediterranean coast, a team with nothing left to lose, two red cards before the fifth minute, and a kidney that filed a formal complaint.',
    content: `<h2>The Reputation</h2>
<p>By the time I played club rugby in France — for Bédarrides, which sits between Orange and Avignon in the Vaucluse — I had long since made my peace with the particular texture of French provincial rugby. It is not like anything else. The standard is serious — Federal 2 is not social rugby. The refereeing can be eccentric, and the attitude towards the laws of the game is sometimes more suggestive than prescriptive. But the intensity is real, and the culture around it — the bus trips, the shared lunches of overcooked pasta and roasted chicken, the long drives home with a beer and a body that is already beginning to itemise its complaints — is something I would not trade.</p>
<p>This was the 2013-14 season, Federal 2. We were log leaders, or close enough to it. We were in form, organised, and we knew it. The match was an away fixture at Six Fours-les-Plages, down on the Mediterranean coast near Toulon, in early November. Late in the season. The kind of fixture that looks straightforward on paper and never is.</p>
<p>You do not simply go to Six Fours and win. That was the first thing understood on the bus. They were last on the log, which meant nothing, because a team with nothing left to lose and a reputation to protect is a dangerous thing. Six Fours had a reputation. So did we. Bédarrides was known as a club that liked to swing apples — which is the polite way of saying that our players were not philosophically opposed to resolving disputes with their fists. I still have footage of some of it. I will publish it one day, when the statute of limitations has run out.</p>
<h2>The Lunch</h2>
<p>I only ate the chicken.</p>
<p>This is important. The French rugby lunch before an away match is a ritual: overcooked pasta in industrial quantities, roasted chicken, bread, a small amount of wine that is technically there but that most people ignore before a game. The pasta is always overcooked. It is a point of consistency in an otherwise unpredictable sport. I have never understood the logic of loading carbohydrates into a body that is about to spend eighty minutes being knocked sideways, so I left the pasta alone and ate the chicken. Protein before effort. The rest is decoration.</p>
<p>I was in good form that season. No serious injuries — which, in rugby, means the small ones barely register. Twisted fingers, bruises that change colour over the course of a week, the occasional stiff neck from a collapsed scrum. You learn to move around these things. They are part of the cost of playing, and you pay them without complaint because the alternative is not playing, and that is worse.</p>
<h2>The Kickoff</h2>
<p>The warmup, as it turned out, was unnecessary.</p>
<p>The man in the red scrum cap — me — you can see it on the video on YouTube — made a hash of the kickoff. I knocked it on and they got a scrum. Which is where things went sideways.</p>
<p>In France there is an expression: <em>relever la mêlée</em>. It refers to what happens when a scrum comes up deliberately — one of the locks slips his bind and punches one of the helpless opposition front rows in the face. The player cannot defend himself because both arms are bound to other players. This signals the start of hostilities. This is exactly what happened in that first scrum.</p>
<p>The fight lasted two or three minutes. I took a few shots early on — my right eye has not been reliable since a winger caught me with a sideways punch in a previous match and I lost my sight in it for three days; the pupil has not worked properly since — so I did what I had long since concluded was the sensible approach to fighting on a rugby field: I got up, looked behind me, and retreated to open ground where nobody could hit me from an angle I was not watching.</p>
<p>I rarely got involved in fighting on the field. I am trying to build a life in France, not go to jail for assault, which is what happened to people I know over exactly this kind of incident. Fighting on a rugby field is a mug's game. You get hit from directions you are not looking. The odds are poor and the consequences are disproportionate.</p>
<p>Our hooker, Gauthier, on the other hand, had no such reservations. Gauthier was well known within the club for his enthusiasm in these situations, and he applied himself with conviction. He laid out several people before the dust settled. He also broke two of his own fingers in the process, which is the kind of detail that only becomes funny later.</p>
<p>When order was eventually restored, the referee produced two red cards for Six Fours and one for Gauthier. We continued with fourteen men against thirteen. The match proper could begin.</p>
<p>It did not improve.</p>
<h2>The Dirty Game</h2>
<p>What followed was the dirtiest game of rugby I have ever played in, and I have played in some matches that would make a citing commissioner weep.</p>
<p>Our captain was head-stamped when the referee was looking the other way. There were fingers in eyes, boots in rucks, and a general attitude from the Six Fours players that the laws of rugby were more of a framework for negotiation than a set of binding instructions. They were last on the log and they had decided that if they were going down, they were going down fighting, in both the metaphorical and the literal sense.</p>
<p>I played well. This is not something I say lightly or often, but it is true and it matters to the story. There was a lineout where I read the play, worked my way through the set piece, and stole the ball from the maul that followed. There was a run where I took the ball up into contact, bumped off multiple defenders, and was brought down just short of the line by three men — leaving our scrumhalf with an open path to the tryline in front of him that he gratefully took. These are the small victories inside a match that do not show up in the score but that you carry home with you.</p>
<h2>The Liver</h2>
<p>Then came the pièce de résistance, and not in a good way.</p>
<p>I took a strong ball up towards their twenty-two. Good line, good carry, the kind of run that was working for me all afternoon. Three players brought me to ground. The ball was already gone — out to our second centre, the move continuing — when one of their players came in late and dropped with both knees directly into my right side. Into the ribs. Into the liver.</p>
<p>Anyone who has watched a liver shot finish a boxing match on YouTube understands what happens next. Your breath disappears. Not reduced — gone. You cannot inhale. You are lying on the ground in a French coastal town in November, fighting for air, and in the absence of anything useful to do with your mind, a part of it starts to quietly negotiate with the universe about whether death might not, in the circumstances, be a mercy.</p>
<p>It passes. If you have played rugby long enough you know this, and the knowing is the only thing that keeps you from genuine panic. You scream — or try to — and you fight for breath, and eventually it comes back, thin and insufficient at first and then more of it, and the world reassembles itself around you. I was replaced. I sat on the side and watched the game tighten, the two red cards beginning to tell against them, our lead beginning to look fragile.</p>
<p>Then they told me to go back on. And I did, because that is what you do.</p>
<p>We won.</p>
<h2>After</h2>
<p>There was another fight after the final whistle. I stayed away from that one without difficulty.</p>
<p>The bus trip home. A few beers, which seemed reasonable. The slow accounting that happens on a long journey back when the adrenaline is gone and the body starts sending its invoices. By the time I got home that night I was stiff, sore, and ready for the story to be over.</p>
<p>Then I went to the toilet and urinated almost pure blood.</p>
<p>The diagnosis: two cracked ribs and a bruised kidney. The doctor's instruction: no rugby for six weeks minimum. I nodded, accepted this, and went home to rest.</p>
<p>Two weeks later, on my birthday, my phone rang. The other lock was down with gastro. Could I play the next day?</p>
<p>I played.</p>
<p>I should not have. I knew it at the time and I knew it during the match, which I spent operating at perhaps sixty percent of my usual capacity — not making contact like I normally would, not carrying with the same conviction, not doing the things a second row is paid in bruises to do. I was, justifiably, given a hard time about it afterwards.</p>
<p>But I played on my birthday, two weeks after a bruised kidney and two cracked ribs, because a teammate needed cover and I said yes. There are worse things to be criticised for.</p>
<p>My surname is Botha. I am not Bakkies. But I have my moments.</p>`,
    image: '/images/SixFours.jpg',
    date: '2026-03-23',
    category: 'Traditions',
...
<p>Ça passe. Si vous avez assez joué au rugby, vous le savez, et ce savoir est la seule chose qui vous empêche de paniquer vraiment. Vous criez, ou vous essayez, et vous vous battez pour reprendre votre souffle, et finalement il revient, mince et insuffisant d'abord, puis davantage, et le monde se recompose autour de vous. J'ai été remplacé. Je me suis assis sur le côté et j'ai regardé le match se resserrer, les deux cartons rouges commençant à peser sur eux, notre avance commençant à paraître fragile.</p>
<p>Puis on m'a dit de remonter sur le terrain. Et je l'ai fait, parce que c'est ce qu'on fait.</p>
<p>On a gagné.</p>
<h2>Après</h2>
<p>Il y a eu une autre bagarre après le coup de sifflet final. Je m'en suis tenu à l'écart sans difficulté.</p>
<p>Le retour en bus. Quelques bières, ce qui semblait raisonnable. Le bilan lent qui se fait lors d'un long trajet de retour quand l'adrénaline est partie et que le corps commence à envoyer ses factures. Au moment où je suis rentré chez moi ce soir-là, j'étais raide, douloureux, et prêt à ce que l'histoire soit terminée.</p>
<p>Puis je suis allé aux toilettes et j'ai uriné presque du sang pur.</p>
<p>Diagnostic : deux côtes fêlées et un rein contusionné. Instruction du médecin : pas de rugby pendant six semaines minimum. J'ai acquiescé, accepté, et je suis rentré me reposer.</p>
<p>Deux semaines plus tard, le jour de mon anniversaire, mon téléphone a sonné. L'autre deuxième ligne était cloué au lit avec une gastro. Est-ce que je pouvais jouer le lendemain ?</p>
<p>J'ai joué.</p>
<p>Je n'aurais pas dû. Je le savais à l'époque et je le savais pendant le match, que j'ai passé à fonctionner à peut-être soixante pour cent de mes capacités habituelles : ne pas rentrer dans le contact comme d'habitude, ne pas porter avec la même conviction, ne pas faire les choses pour lesquelles un deuxième ligne est payé en bleus. On me l'a légitimement reproché après.</p>
<p>Mais j'ai joué le jour de mon anniversaire, deux semaines après un rein contusionné et deux côtes fêlées, parce qu'un coéquipier avait besoin d'un remplaçant et que j'ai dit oui. Il y a de pires choses pour lesquelles être critiqué.</p>
<p>Mon nom de famille est Botha. Je ne suis pas Bakkies. Mais j'ai mes moments.</p>`,
      marcelTip: 'Les pâtes d\'avant-match sont toujours trop cuites. Personne ne sait pourquoi. Personne ne pose la question. C\'est la France.',
    },
  },
];
...
export function getArticles(locale?: string): Article[] {
  ...
  if (locale !== 'fr') return visible;
  return visible.map((a) => (a.fr ? { ...a, ...a.fr } : a));
}
